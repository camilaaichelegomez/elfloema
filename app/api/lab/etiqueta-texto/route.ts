...
- "descripcion_etiqueta": texto BREVE y DESEABLE para IMPRIMIR en la etiqueta física (2-3 oraciones, 30-50 palabras). Es lo primero que lee quien toma el frasco: debe dar GANAS de usarlo. NO abras describiendo qué es ("Gel limpiador que…"); ABRE con la promesa sensorial o el resultado (cómo queda la piel, cómo se siente). Sigue esta fórmula: [qué sientes / cómo queda tu piel] + [cómo lo logra: 1 ingrediente héroe con su función en la piel, y si aplica, que cuida la barrera y respeta el pH de la piel] + [para quién / el ritual de uso]. Cálido y sensorial, sin lista de ingredientes. Si hay un botánico NATIVO de Chile (triwe, maqui, matico, etc.), hazlo protagonista y nombra su origen ("nuestro árbol nativo"). Solo si es cosmético tópico.
  EJEMPLO del nivel (limpiador de triwe): "Limpieza suave que deja el rostro fresco y sin tirantez. El triwe, nuestro árbol nativo, cuida tu barrera cutánea y respeta el pH natural de tu piel. Para tu ritual de cada día." Otro (piel grasa): "Piel limpia y en equilibrio, sin esa sensación tirante. El ácido salicílico y la ortiga regulan el exceso de grasa cuidando tu barrera. Tu limpieza diaria para pieles mixtas a grasas."
