...
export default function BasesCosmetica() {
  ...
  return (
    <div className="parchment-bg bg-vivo" style={{ position: "relative", minHeight: "100vh", background: "linear-gradient(rgba(10,16,10,0.42), rgba(10,16,10,0.6)), url('/fondo_basescosmetica.jpg') center top / cover fixed, var(--bg-primary)", }}>
      <GrainOverlay />
