...
export default function Botanica() {
  ...
  return (
    <main className="parchment-bg bg-vivo" style={{ minHeight: "100vh", paddingBottom: 48, background: "linear-gradient(rgba(10,16,10,0.42), rgba(10,16,10,0.6)), url('/fondo_botanica.jpg') center top / cover fixed, var(--bg-primary)", }}>
      <GrainOverlay />
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "clamp(32px, 6vh, 64px) clamp(24px, 5vw, 56px)", background: "rgba(9,14,9,0.8)", borderRadius: 10, border: "1px solid rgba(200,160,80,0.1)", boxShadow: "0 8px 40px rgba(0,0,0,0.45)" }}>
        ...
        <section style={{ marginBottom: 40 }}>
          ...
          <AccordionItem id="intro" title="¿Qué es la botánica?" open={open === "intro"} onToggle={() => toggle("intro")}>
            <FiguraLibro num="1" titulo="La botanica" src="/biblioteca/botanica/lamina_1.jpg" prompt="Una lamina de estudio con varios especimenes de una planta dispuestos por separado. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: planta entera, hoja, flor, semilla, raiz. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Planta entera · hoja · flor · semilla · raíz" />
          ...
          <AccordionItem id="reino" title="El reino vegetal — qué hace única a una planta" open={open === "reino"} onToggle={() => toggle("reino")}>
            <FiguraLibro num="2" titulo="El reino vegetal" src="/biblioteca/botanica/lamina_2.jpg" prompt="Una lamina comparativa de formas del reino vegetal, cada una como especimen separado. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: arbol, arbusto, hierba, helecho, musgo. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Árbol · arbusto · hierba · helecho · musgo" />
          ...
          <AccordionItem id="celula" title="La célula vegetal — estructura detallada" open={open === "celula"} onToggle={() => toggle("celula")}>
            <FiguraLibro num="3" titulo="La celula vegetal" src="/biblioteca/botanica/lamina_3.jpg" prompt="Un diagrama en corte de una celula vegetal como figura de manual. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: pared celular, membrana, citoplasma, nucleo, cloroplastos, vacuola central, mitocondria. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Pared celular · núcleo · cloroplastos · vacuola central" />
          ...
          <AccordionItem id="tejidos" title="Tejidos vegetales" open={open === "tejidos"} onToggle={() => toggle("tejidos")}>
            <FiguraLibro num="4" titulo="Tejidos vegetales" src="/biblioteca/botanica/lamina_4.jpg" prompt="Un corte transversal de un tallo mostrando sus tejidos. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: epidermis, cortex, haz vascular, xilema, floema, cambium vascular, medula. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Epidermis · córtex · haz vascular · xilema · floema · cámbium · médula" />
          ...
          <AccordionItem id="organos-1" title="Los órganos — raíz, tallo y hoja" open={open === "organos-1"} onToggle={() => toggle("organos-1")}>
            <FiguraLibro num="5" titulo="Raiz, tallo y hoja" src="/biblioteca/botanica/lamina_5.jpg" prompt="Una lamina comparativa de los tipos de raiz, cada uno por separado, mas un tallo y una hoja. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: raiz pivotante, raiz fibrosa, raiz tuberosa, raices aereas, tallo, hoja. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Raíz pivotante · fibrosa · tuberosa · aérea · tallo · hoja" />
          ...
          <AccordionItem id="organos-2" title="Los órganos — flor, fruto y semilla" open={open === "organos-2"} onToggle={() => toggle("organos-2")}>
            <FiguraLibro num="6" titulo="Flor, fruto y semilla" src="/biblioteca/botanica/lamina_6.jpg" prompt="La anatomia de una flor en corte, junto a un fruto partido y una semilla germinando. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: petalo, estambre, pistilo, ovario, fruto, semilla. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Flor en corte · fruto · semilla germinando" />
          ...
          <AccordionItem id="clasificacion" title="La clasificación botánica" open={open === "clasificacion"} onToggle={() => toggle("clasificacion")}>
            <FiguraLibro num="7" titulo="La clasificacion botanica" src="/biblioteca/botanica/lamina_7.jpg" prompt="Un diagrama de arbol ramificado de la clasificacion de las plantas. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: reino, division, clase, orden, familia, genero, especie. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Reino · división · clase · orden · familia · género · especie" />
...
Especie:  Piper aduncum`}</CodeBlock>
          ...
          <AccordionItem id="familias" title="Las grandes familias de plantas medicinales" open={open === "familias"} onToggle={() => toggle("familias")}>
            <FiguraLibro num="8" titulo="Las grandes familias" src="/biblioteca/botanica/lamina_8.jpg" prompt="Un muestrario de ejemplares de distintas familias de plantas medicinales. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: Piperaceas, Asteraceas, Onagraceas, Lamiaceas, Rosaceas. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Piperáceas · Asteráceas · Onagráceas · Lamiáceas · Rosáceas" />
          ...
          <AccordionItem id="ciclos" title="Ciclos de vida y cosecha" open={open === "ciclos"} onToggle={() => toggle("ciclos")}>
            <FiguraLibro num="9" titulo="Ciclos y cosecha" src="/biblioteca/botanica/lamina_9.jpg" prompt="Una secuencia circular del ciclo de vida de una planta. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: semilla, brote, planta joven, floracion, fruto, senescencia. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Semilla · brote · planta joven · floración · fruto · senescencia" />
          ...
          <AccordionItem id="valdiviano" title="El bosque valdiviano — por qué sus plantas son únicas" open={open === "valdiviano"} onToggle={() => toggle("valdiviano")}>
            <FiguraLibro num="10" titulo="El bosque valdiviano" src="/biblioteca/botanica/lamina_10.jpg" prompt="El bosque templado valdiviano con sus arboles caracteristicos. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: canelo, arrayan, helechos, musgo. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Canelo · arrayán · helechos · musgo" />
