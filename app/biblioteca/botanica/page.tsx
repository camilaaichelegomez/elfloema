...
function AccordionItem({ title, open, onToggle, children }: AccordionItemProps) {
  return (
    <div style={{ border: `1px solid ${open ? "rgba(200,160,80,0.3)" : "rgba(200,160,80,0.1)"}`, borderRadius: "0.5rem", marginBottom: "0.5rem", background: open ? "rgba(200,160,80,0.04)" : "transparent", transition: "border-color 0.3s, background 0.3s", overflow: "hidden" }}>
      <button onClick={(e) => { const el = e.currentTarget as HTMLElement; const abrir = !open; onToggle(); if (abrir) setTimeout(() => window.scrollTo({ top: el.getBoundingClientRect().top + window.scrollY - 90, behavior: "smooth" }), 220); }} style={{ width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center", padding: "1rem 1.25rem", background: "none", border: "none", cursor: "pointer", textAlign: "left", gap: "1rem" }}>
      ...
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "clamp(32px, 6vh, 64px) clamp(24px, 5vw, 56px)" }}>
        ...
        <section style={{ marginBottom: 40 }}>
          ...
          <AccordionItem id="intro" title="¿Qué es la botánica?" open={open === "intro"} onToggle={() => toggle("intro")}>
            <FiguraLibro num="1" titulo="La botanica" src="/biblioteca/botanica/lamina-1.svg" prompt="Una lamina de estudio botanico con varios especimenes dispuestos en hileras: una planta entera pequena, una hoja, una flor, una semilla y una raiz, cada uno dibujado por separado. Ilustracion cientifica de libro de botanica antiguo, dibujo a tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. La explicacion debe venir del dibujo (varios especimenes, un corte o una secuencia), NO de texto. Solo la ilustracion, limpia." leyenda="Planta entera · hoja · flor · semilla · raíz" />
          ...
          <AccordionItem id="reino" title="El reino vegetal — qué hace única a una planta" open={open === "reino"} onToggle={() => toggle("reino")}>
            <FiguraLibro num="2" titulo="El reino vegetal" src="/biblioteca/botanica/lamina-2.png" prompt="Una lamina comparativa de la diversidad del reino vegetal: un arbol, un arbusto, una hierba, un helecho y un musgo, cada uno dibujado como especimen separado uno al lado del otro. Ilustracion cientifica de libro de botanica antiguo, dibujo a tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. La explicacion debe venir del dibujo (varios especimenes, un corte o una secuencia), NO de texto. Solo la ilustracion, limpia." leyenda="Árbol · arbusto · hierba · helecho · musgo" />
          ...
          <AccordionItem id="celula" title="La célula vegetal — estructura detallada" open={open === "celula"} onToggle={() => toggle("celula")}>
            <FiguraLibro num="3" titulo="La celula vegetal" src="/biblioteca/botanica/lamina-3.png" prompt="Un gran diagrama en corte de una unica celula vegetal como figura de manual: se ven claramente la pared celular, el nucleo, varios cloroplastos verdes ovalados y una gran vacuola central, cada estructura como forma distinta. Ilustracion cientifica de libro de botanica antiguo, dibujo a tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. La explicacion debe venir del dibujo (varios especimenes, un corte o una secuencia), NO de texto. Solo la ilustracion, limpia." leyenda="Pared celular · núcleo · cloroplastos · vacuola central" />
          ...
          <AccordionItem id="tejidos" title="Tejidos vegetales" open={open === "tejidos"} onToggle={() => toggle("tejidos")}>
            <FiguraLibro num="4" titulo="Tejidos vegetales" src="/biblioteca/botanica/lamina-4.png" prompt="Un corte transversal de un tallo como diagrama de libro: capas concentricas de tejidos y haces de vasos conductores bien diferenciados, y a un lado un pelo glandular ampliado. Ilustracion cientifica de libro de botanica antiguo, dibujo a tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. La explicacion debe venir del dibujo (varios especimenes, un corte o una secuencia), NO de texto. Solo la ilustracion, limpia." leyenda="Epidermis · xilema · floema · pelo glandular" />
          ...
          <AccordionItem id="organos-1" title="Los órganos — raíz, tallo y hoja" open={open === "organos-1"} onToggle={() => toggle("organos-1")}>
            <FiguraLibro num="5" titulo="Raiz, tallo y hoja" src="/biblioteca/botanica/lamina-5.png" prompt="Una lamina comparativa de los TIPOS DE RAIZ, cada uno dibujado por separado en hilera: una raiz pivotante tipo zanahoria, una raiz fibrosa en cabellera, una raiz tuberosa engrosada y raices aereas; al lado, un tallo y una hoja mostrando sus nervaduras. Ilustracion cientifica de libro de botanica antiguo, dibujo a tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. La explicacion debe venir del dibujo (varios especimenes, un corte o una secuencia), NO de texto. Solo la ilustracion, limpia." leyenda="Raíz pivotante · fibrosa · tuberosa · aérea · tallo · hoja" />
          ...
          <AccordionItem id="organos-2" title="Los órganos — flor, fruto y semilla" open={open === "organos-2"} onToggle={() => toggle("organos-2")}>
            <FiguraLibro num="6" titulo="Flor, fruto y semilla" src="/biblioteca/botanica/lamina-6.png" prompt="Una lamina de la flor, el fruto y la semilla: una flor abierta en corte mostrando sus partes, junto a un fruto partido por la mitad y una semilla germinando en secuencia. Ilustracion cientifica de libro de botanica antiguo, dibujo a tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. La explicacion debe venir del dibujo (varios especimenes, un corte o una secuencia), NO de texto. Solo la ilustracion, limpia." leyenda="Flor en corte · fruto · semilla germinando" />
          ...
          <AccordionItem id="clasificacion" title="La clasificación botánica" open={open === "clasificacion"} onToggle={() => toggle("clasificacion")}>
            <FiguraLibro num="7" titulo="La clasificacion botanica" src="/biblioteca/botanica/lamina-7.png" prompt="Un diagrama de arbol ramificado que se subdivide desde un tronco en ramas cada vez mas finas, con hojas y flores, como esquema de la clasificacion de las plantas. Ilustracion cientifica de libro de botanica antiguo, dibujo a tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. La explicacion debe venir del dibujo (varios especimenes, un corte o una secuencia), NO de texto. Solo la ilustracion, limpia." leyenda="Reino · división · clase · orden · familia · género · especie" />
...
Especie:  Piper aduncum`}</CodeBlock>
          ...
          <AccordionItem id="familias" title="Las grandes familias de plantas medicinales" open={open === "familias"} onToggle={() => toggle("familias")}>
            <FiguraLibro num="8" titulo="Las grandes familias" src="/biblioteca/botanica/lamina-8.png" prompt="Un muestrario botanico con ejemplares de distintas familias de plantas medicinales dispuestos en cuadricula, cada uno con su hoja y flor caracteristica, como catalogo de herbario. Ilustracion cientifica de libro de botanica antiguo, dibujo a tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. La explicacion debe venir del dibujo (varios especimenes, un corte o una secuencia), NO de texto. Solo la ilustracion, limpia." leyenda="Piperáceas · Asteráceas · Onagráceas · Lamiáceas · Rosáceas" />
          ...
          <AccordionItem id="ciclos" title="Ciclos de vida y cosecha" open={open === "ciclos"} onToggle={() => toggle("ciclos")}>
            <FiguraLibro num="9" titulo="Ciclos y cosecha" src="/biblioteca/botanica/lamina-9.png" prompt="Una secuencia circular del ciclo de una planta como diagrama: semilla, brote, planta joven, planta florecida, fruto y planta seca, ordenados en circulo. Ilustracion cientifica de libro de botanica antiguo, dibujo a tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. La explicacion debe venir del dibujo (varios especimenes, un corte o una secuencia), NO de texto. Solo la ilustracion, limpia." leyenda="Semilla · brote · planta joven · floración · fruto · senescencia" />
          ...
          <AccordionItem id="valdiviano" title="El bosque valdiviano — por qué sus plantas son únicas" open={open === "valdiviano"} onToggle={() => toggle("valdiviano")}>
            <FiguraLibro num="10" titulo="El bosque valdiviano" src="/biblioteca/botanica/lamina-10.png" prompt="El bosque templado valdiviano entre la niebla, con canelos, arrayanes de corteza rojiza, helechos gigantes y musgo, luz filtrandose entre los troncos. Ilustracion cientifica de libro de botanica antiguo, dibujo a tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. La explicacion debe venir del dibujo (varios especimenes, un corte o una secuencia), NO de texto. Solo la ilustracion, limpia." leyenda="Canelo · arrayán · helechos · musgo" />
