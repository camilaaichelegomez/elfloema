    ...
    >
      ...
      >
        ...
        >
          ...
          <FiguraLibro num="1" titulo="Fisiología de la planta" src="/biblioteca/fisiologia/lamina-1.png" prompt="Una planta entera dibujada como estudio junto a un detalle ampliado de una hoja mostrando su interior verde lleno de pequenas estructuras que trabajan. Ilustracion cientifica de libro de botanica antiguo, tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. La explicacion viene del dibujo, NO de texto. Sin marca de agua. Solo la ilustracion, limpia." leyenda="La planta: una fábrica química viva" />
            <BodyText>
          ...
          <FiguraLibro num="2" titulo="La célula vegetal" src="/biblioteca/fisiologia/lamina-2.png" prompt="Un gran diagrama en corte de una unica celula vegetal como figura de manual: pared celular, nucleo, varios cloroplastos verdes ovalados y una gran vacuola central, cada estructura distinta. Ilustracion cientifica de libro de botanica antiguo, tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. La explicacion viene del dibujo, NO de texto. Sin marca de agua. Solo la ilustracion, limpia." leyenda="Pared · núcleo · cloroplastos · vacuola · mitocondria" />
            <BodyText>
          ...
          <FiguraLibro num="3" titulo="Fotosíntesis" src="/biblioteca/fisiologia/lamina-3.png" prompt="Un diagrama de la fotosintesis en una hoja: el sol y sus rayos llegando a la hoja verde, agua subiendo por el tallo, aire entrando y pequenas burbujas de oxigeno saliendo; dentro, cloroplastos. Ilustracion cientifica de libro de botanica antiguo, tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. La explicacion viene del dibujo, NO de texto. Sin marca de agua. Solo la ilustracion, limpia." leyenda="Luz · CO₂ · agua → glucosa · oxígeno" />
          ...
          <FiguraLibro num="4" titulo="El floema y el xilema" src="/biblioteca/fisiologia/lamina-4.png" prompt="Un corte longitudinal de un tallo mostrando dos grupos de tubos conductores: unos que llevan agua hacia arriba y otros savia elaborada hacia abajo, como diagrama. Ilustracion cientifica de libro de botanica antiguo, tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. La explicacion viene del dibujo, NO de texto. Sin marca de agua. Solo la ilustracion, limpia." leyenda="Xilema (sube agua) · floema (baja savia)" />
            <BodyText>
          ...
          <FiguraLibro num="5" titulo="Defensa química" src="/biblioteca/fisiologia/lamina-5.png" prompt="Una planta en el centro rodeada de amenazas dibujadas alrededor -un insecto mordiendo, un sol intenso, tierra seca- y de la planta emanan pequenas formas protectoras. Ilustracion cientifica de libro de botanica antiguo, tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. La explicacion viene del dibujo, NO de texto. Sin marca de agua. Solo la ilustracion, limpia." leyenda="Herbívoros · UV · sequía → defensa química" />
            <BodyText>
          ...
          <FiguraLibro num="6" titulo="De la planta a la piel" src="/biblioteca/fisiologia/lamina-6.png" prompt="Una gota de extracto vegetal cayendo desde una planta hacia una seccion de piel en capas, como diagrama de transferencia. Ilustracion cientifica de libro de botanica antiguo, tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. La explicacion viene del dibujo, NO de texto. Sin marca de agua. Solo la ilustracion, limpia." leyenda="Extracto vegetal → activo en la piel" />
            <BodyText>
