    ...
    <main className="parchment-bg" style={{ minHeight: "100vh", paddingBottom: 48 }}>
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "clamp(32px, 6vh, 64px) clamp(24px, 5vw, 56px)" }}>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <FiguraLibro num="1" titulo="Polifenoles" src="/biblioteca/metabolitos/lamina-1.png" prompt="Racimos de bayas oscuras moradas y hojas verdes junto a pequenas formas hexagonales que representan moleculas antioxidantes difundiendose. Ilustracion cientifica de libro de botanica antiguo, tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. La explicacion viene del dibujo, NO de texto. Sin marca de agua. Solo la ilustracion, limpia." leyenda="Antioxidantes — ej. maqui, té verde" />
          ...
          <FiguraLibro num="2" titulo="Flavonoides" src="/biblioteca/metabolitos/lamina-2.png" prompt="Flores y frutas de colores vivos amarillo, azul y rojo con sus pigmentos dibujados irradiando. Ilustracion cientifica de libro de botanica antiguo, tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. La explicacion viene del dibujo, NO de texto. Sin marca de agua. Solo la ilustracion, limpia." leyenda="Pigmentos protectores — quercetina, antocianinas" />
            <p style={{ fontSize: "0.97rem", lineHeight: 1.8, color: "#d4c4a0", marginBottom: 14 }}>
          ...
          <FiguraLibro num="3" titulo="Taninos" src="/biblioteca/metabolitos/lamina-3.png" prompt="Corteza de arbol, hojas y un trozo de cuero curtido, con textura rugosa y astringente en tonos marrones. Ilustracion cientifica de libro de botanica antiguo, tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. La explicacion viene del dibujo, NO de texto. Sin marca de agua. Solo la ilustracion, limpia." leyenda="Astringentes — corteza, hojas, taninos" />
            <p style={{ fontSize: "0.97rem", lineHeight: 1.8, color: "#d4c4a0", marginBottom: 14 }}>
          ...
          <FiguraLibro num="4" titulo="Terpenos" src="/biblioteca/metabolitos/lamina-4.png" prompt="Gotas de resina ambar y aceite brotando de coniferas y hierbas aromaticas, con vapores fragantes visibles. Ilustracion cientifica de libro de botanica antiguo, tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. La explicacion viene del dibujo, NO de texto. Sin marca de agua. Solo la ilustracion, limpia." leyenda="Aromáticos y resinas — aceites esenciales" />
            <p style={{ fontSize: "0.97rem", lineHeight: 1.8, color: "#d4c4a0", marginBottom: 14 }}>
          ...
          <FiguraLibro num="5" titulo="Alcaloides" src="/biblioteca/metabolitos/lamina-5.png" prompt="Plantas de aspecto potente, una amapola y una rama de cafe, con pequenas formas que representan compuestos activos concentrados. Ilustracion cientifica de libro de botanica antiguo, tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. La explicacion viene del dibujo, NO de texto. Sin marca de agua. Solo la ilustracion, limpia." leyenda="Nitrogenados potentes — cafeína, morfina" />
            <p style={{ fontSize: "0.97rem", lineHeight: 1.8, color: "#d4c4a0", marginBottom: 14 }}>
          ...
          <FiguraLibro num="6" titulo="Glucósidos" src="/biblioteca/metabolitos/lamina-6.png" prompt="Una forma de azucar dorada unida a una hoja verde por un enlace, formas organicas de union con brillo suave. Ilustracion cientifica de libro de botanica antiguo, tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. La explicacion viene del dibujo, NO de texto. Sin marca de agua. Solo la ilustracion, limpia." leyenda="Azúcar + parte activa — cardiotónicos" />
            <p style={{ fontSize: "0.97rem", lineHeight: 1.8, color: "#d4c4a0", marginBottom: 14 }}>
          ...
          <FiguraLibro num="7" titulo="Aceites esenciales" src="/biblioteca/metabolitos/lamina-7.png" prompt="Un frasco de aceite esencial rodeado de las plantas aromaticas de origen -lavanda, menta, eucalipto- con vapores elevandose. Ilustracion cientifica de libro de botanica antiguo, tinta fina y acuarela suave en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema envejecido, especimenes claros y detallados como lamina didactica de manual. MUY IMPORTANTE: sin ningun texto, ni letras, ni palabras, ni etiquetas, ni numeros, ni rotulos, ni escritura de ningun tipo en ninguna parte. La explicacion viene del dibujo, NO de texto. Sin marca de agua. Solo la ilustracion, limpia." leyenda="Mezclas volátiles — mono y sesquiterpenos" />
            <p style={{ fontSize: "0.97rem", lineHeight: 1.8, color: "#d4c4a0", marginBottom: 14 }}>
