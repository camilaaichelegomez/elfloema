...
export default function MetabolitosSecundarios() {
  return (
    <main className="parchment-bg bg-vivo" style={{ minHeight: "100vh", paddingBottom: 48, background: "linear-gradient(rgba(10,16,10,0.42), rgba(10,16,10,0.6)), url('/fondo_metabolitossecundarios.jpg') center top / cover fixed, var(--bg-primary)", }}>
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "clamp(32px, 6vh, 64px) clamp(24px, 5vw, 56px)", background: "rgba(9,14,9,0.8)", borderRadius: 10, border: "1px solid rgba(200,160,80,0.1)", boxShadow: "0 8px 40px rgba(0,0,0,0.45)" }}>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <FiguraLibro num="2" titulo="Flavonoides" src="/biblioteca/metabolitos/lamina-2.jpg" prompt="Flores y frutas de colores vivos con sus pigmentos. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: flavonoides, quercetina, antocianinas. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Pigmentos protectores — quercetina, antocianinas" />
            <p style={{ fontSize: "0.97rem", lineHeight: 1.8, color: "#d4c4a0", marginBottom: 14 }}>
          ...
          <FiguraLibro num="3" titulo="Taninos" src="/biblioteca/metabolitos/lamina-3.jpg" prompt="Corteza, hojas y cuero curtido, texturas astringentes. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: taninos, astringentes. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Astringentes — corteza, hojas, taninos" />
            <p style={{ fontSize: "0.97rem", lineHeight: 1.8, color: "#d4c4a0", marginBottom: 14 }}>
          ...
          <FiguraLibro num="4" titulo="Terpenos" src="/biblioteca/metabolitos/lamina-4.jpg" prompt="Resina y aceite brotando de coniferas y hierbas aromaticas. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: terpenos, aceites esenciales, resinas. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Aromáticos y resinas — aceites esenciales" />
            <p style={{ fontSize: "0.97rem", lineHeight: 1.8, color: "#d4c4a0", marginBottom: 14 }}>
          ...
          <FiguraLibro num="6" titulo="Glucósidos" src="/biblioteca/metabolitos/lamina-6.jpg" prompt="Un azucar unido a una hoja por un enlace. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: azucar, aglicona (parte activa). No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Azúcar + parte activa — cardiotónicos" />
            <p style={{ fontSize: "0.97rem", lineHeight: 1.8, color: "#d4c4a0", marginBottom: 14 }}>
          ...
          <FiguraLibro num="7" titulo="Aceites esenciales" src="/biblioteca/metabolitos/lamina-7.jpg" prompt="Un frasco de aceite esencial rodeado de plantas aromaticas con vapores. Estilo lamina didactica de libro de botanica antiguo, ilustracion a tinta y acuarela en tonos sepia, marron y verde apagado, sobre fondo de pergamino crema, aspecto de figura de manual. IMPORTANTE: la imagen DEBE incluir rotulos de texto en ESPANOL, con letra serif clara y ortografia correcta, con finas lineas guia que apuntan a cada parte, como figura de libro de botanica. Rotula exactamente estas partes: aceites esenciales, monoterpenos, sesquiterpenos. No pongas ningun otro texto ni marca de agua fuera de esos rotulos." leyenda="Mezclas volátiles — mono y sesquiterpenos" />
            <p style={{ fontSize: "0.97rem", lineHeight: 1.8, color: "#d4c4a0", marginBottom: 14 }}>
