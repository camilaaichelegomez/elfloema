...
export default function MetodosExtraccion() {
  ...
  return (
    <main className="parchment-bg bg-vivo" style={{ minHeight: "100vh", paddingBottom: 48, background: "linear-gradient(rgba(10,16,10,0.42), rgba(10,16,10,0.6)), url('/metodos_deextraccion.jpg') center top / cover fixed, var(--bg-primary)" }}>
      <GrainOverlay />
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "clamp(32px, 6vh, 64px) clamp(24px, 5vw, 56px)", background: "rgba(9,14,9,0.8)", borderRadius: 10, border: "1px solid rgba(200,160,80,0.1)", boxShadow: "0 8px 40px rgba(0,0,0,0.45)" }}>
        ...
        <section style={{ marginBottom: 40 }}>
          ...
          <AccordionItem id="infusion" title="1 · Infusión" open={open === "infusion"} onToggle={() => toggle("infusion")}>
            <FiguraLibro num="1" titulo="Infusión" src="/biblioteca/metodos/lamina-1.jpg" prompt="Una tetera de vidrio transparente con flores y hojas flotando en agua caliente y vapor subiendo, sobre fondo oscuro. Ilustracion botanica antigua pintada a mano, tinta y acuarela, tonos sepia y dorado envejecido sobre fondo verde bosque muy oscuro, estetica de grimorio, luz calida y atmosferica, muy detallada. MUY IMPORTANTE: la imagen NO debe tener ningun texto, ni letras, ni palabras, ni etiquetas, ni rotulos, ni numeros, ni titulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. Solo la ilustracion, completamente limpia y sin texto." leyenda="Hojas y flores · 80–95 °C · tapado" />
          ...
          <AccordionItem id="decoccion" title="2 · Decocción" open={open === "decoccion"} onToggle={() => toggle("decoccion")}>
            <FiguraLibro num="2" titulo="Decocción" src="/biblioteca/metodos/lamina-2.jpg" prompt="Una olla sobre el fuego con raices y trozos de corteza hirviendo en agua, burbujas y vapor. Ilustracion botanica antigua pintada a mano, tinta y acuarela, tonos sepia y dorado envejecido sobre fondo verde bosque muy oscuro, estetica de grimorio, luz calida y atmosferica, muy detallada. MUY IMPORTANTE: la imagen NO debe tener ningun texto, ni letras, ni palabras, ni etiquetas, ni rotulos, ni numeros, ni titulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. Solo la ilustracion, completamente limpia y sin texto." leyenda="Cortezas y raíces · 100 °C · hervido" />
          ...
          <AccordionItem id="maceracion-fria" title="3 · Maceración fría acuosa" open={open === "maceracion-fria"} onToggle={() => toggle("maceracion-fria")}>
            <FiguraLibro num="3" titulo="Maceración fría" src="/biblioteca/metodos/lamina-3.jpg" prompt="Un frasco de vidrio cerrado con hierbas sumergidas en agua fria, el agua tenida de verde, gotas de condensacion. Ilustracion botanica antigua pintada a mano, tinta y acuarela, tonos sepia y dorado envejecido sobre fondo verde bosque muy oscuro, estetica de grimorio, luz calida y atmosferica, muy detallada. MUY IMPORTANTE: la imagen NO debe tener ningun texto, ni letras, ni palabras, ni etiquetas, ni rotulos, ni numeros, ni titulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. Solo la ilustracion, completamente limpia y sin texto." leyenda="Activos sensibles · agua fría · días o semanas" />
          ...
          <AccordionItem id="tintura" title="4 · Tintura alcohólica" open={open === "tintura"} onToggle={() => toggle("tintura")}>
            <FiguraLibro num="4" titulo="Tintura" src="/biblioteca/metodos/lamina-4.jpg" prompt="Un frasco de vidrio ambar con un gotero, lleno de liquido dorado oscuro y hierbas macerando dentro. Ilustracion botanica antigua pintada a mano, tinta y acuarela, tonos sepia y dorado envejecido sobre fondo verde bosque muy oscuro, estetica de grimorio, luz calida y atmosferica, muy detallada. MUY IMPORTANTE: la imagen NO debe tener ningun texto, ni letras, ni palabras, ni etiquetas, ni rotulos, ni numeros, ni titulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. Solo la ilustracion, completamente limpia y sin texto." leyenda="Alcohol 60–70° · extracto concentrado" />
          ...
          <AccordionItem id="glicerico" title="5 · Macerado glicérico" open={open === "glicerico"} onToggle={() => toggle("glicerico")}>
            <FiguraLibro num="5" titulo="Macerado glicérico" src="/biblioteca/metodos/lamina-5.jpg" prompt="Un frasco de vidrio con hierbas sumergidas en un liquido dorado espeso y brillante, textura de glicerina. Ilustracion botanica antigua pintada a mano, tinta y acuarela, tonos sepia y dorado envejecido sobre fondo verde bosque muy oscuro, estetica de grimorio, luz calida y atmosferica, muy detallada. MUY IMPORTANTE: la imagen NO debe tener ningun texto, ni letras, ni palabras, ni etiquetas, ni rotulos, ni numeros, ni titulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. Solo la ilustracion, completamente limpia y sin texto." leyenda="Sin alcohol · en glicerina" />
          ...
          <AccordionItem id="oleomacerado" title="6 · Maceración en aceite — oleomacerado" open={open === "oleomacerado"} onToggle={() => toggle("oleomacerado")}>
            <FiguraLibro num="6" titulo="Oleomacerado" src="/biblioteca/metodos/lamina-6.jpg" prompt="Un frasco de vidrio con flores amarillas sumergidas en aceite dorado, iluminado por el sol en una ventana. Ilustracion botanica antigua pintada a mano, tinta y acuarela, tonos sepia y dorado envejecido sobre fondo verde bosque muy oscuro, estetica de grimorio, luz calida y atmosferica, muy detallada. MUY IMPORTANTE: la imagen NO debe tener ningun texto, ni letras, ni palabras, ni etiquetas, ni rotulos, ni numeros, ni titulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. Solo la ilustracion, completamente limpia y sin texto." leyenda="Activos en aceite · maceración solar" />
          ...
          <AccordionItem id="tallow" title="7 · Maceración en sebo — oleomacerado en tallow" open={open === "tallow"} onToggle={() => toggle("tallow")}>
            <FiguraLibro num="7" titulo="Maceración en tallow" src="/biblioteca/metodos/lamina-7.jpg" prompt="Una olla a bano maria con grasa blanca derretida y hierbas verdes infusionando dentro, vapor suave. Ilustracion botanica antigua pintada a mano, tinta y acuarela, tonos sepia y dorado envejecido sobre fondo verde bosque muy oscuro, estetica de grimorio, luz calida y atmosferica, muy detallada. MUY IMPORTANTE: la imagen NO debe tener ningun texto, ni letras, ni palabras, ni etiquetas, ni rotulos, ni numeros, ni titulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. Solo la ilustracion, completamente limpia y sin texto." leyenda="Activos en sebo (tallow) · baño maría" />
          ...
          <AccordionItem id="hidrodestilacion" title="8 · Hidrodestilación — aceites esenciales e hidrolatos" open={open === "hidrodestilacion"} onToggle={() => toggle("hidrodestilacion")}>
            <FiguraLibro num="8" titulo="Hidrodestilación" src="/biblioteca/metodos/lamina-8.jpg" prompt="Un alambique de cobre antiguo destilando, con vapor pasando por un serpentin y goteando en un frasco. Ilustracion botanica antigua pintada a mano, tinta y acuarela, tonos sepia y dorado envejecido sobre fondo verde bosque muy oscuro, estetica de grimorio, luz calida y atmosferica, muy detallada. MUY IMPORTANTE: la imagen NO debe tener ningun texto, ni letras, ni palabras, ni etiquetas, ni rotulos, ni numeros, ni titulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. Solo la ilustracion, completamente limpia y sin texto." leyenda="Aceite esencial + hidrolato · destilación al vapor" />
          ...
          <AccordionItem id="enfleurage" title="9 · Enfleurage" open={open === "enfleurage"} onToggle={() => toggle("enfleurage")}>
            <FiguraLibro num="9" titulo="Enfleurage" src="/biblioteca/metodos/lamina-9.jpg" prompt="Petalos de flores frescas presionados sobre una capa de grasa blanca en un marco de madera. Ilustracion botanica antigua pintada a mano, tinta y acuarela, tonos sepia y dorado envejecido sobre fondo verde bosque muy oscuro, estetica de grimorio, luz calida y atmosferica, muy detallada. MUY IMPORTANTE: la imagen NO debe tener ningun texto, ni letras, ni palabras, ni etiquetas, ni rotulos, ni numeros, ni titulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. Solo la ilustracion, completamente limpia y sin texto." leyenda="Perfume atrapado en grasa · en frío" />
          ...
          <AccordionItem id="cataplasma" title="10 · Cataplasma" open={open === "cataplasma"} onToggle={() => toggle("cataplasma")}>
            <FiguraLibro num="10" titulo="Cataplasma" src="/biblioteca/metodos/lamina-10.jpg" prompt="Hierbas frescas machacadas en un mortero, extendidas sobre un pano de lino doblado, como emplasto. Ilustracion botanica antigua pintada a mano, tinta y acuarela, tonos sepia y dorado envejecido sobre fondo verde bosque muy oscuro, estetica de grimorio, luz calida y atmosferica, muy detallada. MUY IMPORTANTE: la imagen NO debe tener ningun texto, ni letras, ni palabras, ni etiquetas, ni rotulos, ni numeros, ni titulos, ni escritura de ningun tipo en ninguna parte. Nada de tipografia. Sin marca de agua. Solo la ilustracion, completamente limpia y sin texto." leyenda="Planta fresca machacada · uso tópico" />
