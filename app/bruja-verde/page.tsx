...
export default function BrujaVerde() {
  ...
  return (
    <main className="parchment-bg bg-vivo" style={{ minHeight: "100vh", paddingBottom: 48, background: "linear-gradient(rgba(10,16,10,0.58), rgba(10,16,10,0.74)), url('/fondo_brujaverde.jpg') center top / cover fixed, var(--bg-primary)", }}>
      <GrainOverlay />
