...
const WELCOME =
  "Hola, soy Floema 🧪 Tu asistente de formulación cosmética. Pregúntame sobre fases, porcentajes, emulsionantes, conservantes o cualquier ingrediente para tus fórmulas.";
...
export default function FormulacionPage() {
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background: "linear-gradient(rgba(8,14,8,0.58), rgba(8,14,8,0.74)), url('/fondo_formulacion.jpg') center top / cover fixed, var(--bg-primary)",
        display: "flex",
              ...
              {[0, 1, 2].map((j) => (
                <span
                  ...
                  style={{
                    ...
                    opacity: 0.4,
                    display: "block",
                    animation: `formulacionDot 1.2s ease-in-out ${j * 0.2}s infinite`,
                  }}
                />
              ))}
            </div>
      ...
      >
        ...
        >
          <textarea
            ...
            placeholder="Pregunta sobre ingredientes, fases, porcentajes..."
            rows={1}
            style={{
              flex: 1,
              background: "var(--bg-card)",
        ...
        >
          Formulación cosmética · El Floema
        </p>
      </div>

      <style>{`
        @keyframes formulacionDot {
