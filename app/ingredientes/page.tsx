...
export default function Ingredientes() {
  ...
  return (
    <div className="parchment-bg" style={{ position: "relative", minHeight: "100vh", background: "linear-gradient(rgba(10,16,10,0.58), rgba(10,16,10,0.74)), url('/fondo_ingredientes.jpg') center top / cover fixed, var(--bg-primary)", }}>
      <GrainOverlay />
