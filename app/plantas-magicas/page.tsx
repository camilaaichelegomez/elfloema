...
export default function PlantasMagicas() {
  ...
  return (
    <main className="parchment-bg" style={{ minHeight: "100vh", paddingBottom: 48, background: "linear-gradient(rgba(10,16,10,0.42), rgba(10,16,10,0.6)), url('/fondo_brujaverde.jpg') center top / cover fixed, var(--bg-primary)", }}>
      <GrainOverlay />
