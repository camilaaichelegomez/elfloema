...
export default async function PlantaPage({
  ...
  return (
    <>
      <Navbar />
      <main className="bg-vivo" style={{ background: "linear-gradient(rgba(10,16,10,0.42), rgba(10,16,10,0.6)), url('/fondo_fichaplanta.jpg') center top / cover fixed, var(--bg-primary)", minHeight: "100vh", paddingTop: "5rem" }}>
