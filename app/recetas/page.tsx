...
export default async function RecetasPage() {
  ...
  return (
    <div className="parchment-bg" style={{ position: "relative", minHeight: "100vh", background: "linear-gradient(rgba(10,16,10,0.5), rgba(10,16,10,0.68)), url('/fondo_recetas.jpg') center top / cover fixed, var(--bg-primary)" }}>
      <GrainOverlay />
