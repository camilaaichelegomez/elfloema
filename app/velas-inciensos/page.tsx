...
export default function VelasInciensos() {
  ...
  return (
    <main className="parchment-bg bg-vivo" style={{ minHeight: "100vh", paddingBottom: 48, background: "linear-gradient(rgba(10,16,10,0.42), rgba(10,16,10,0.6)), url('/fondo_velas.jpg') center top / cover fixed, var(--bg-primary)", }}>
      <GrainOverlay />
