/* Bases de cosmética de la Biblioteca — fuente única de verdad.

   Antes vivían dentro de app/formulas/page.tsx mezcladas con el maquetado, así
   que no se podían reutilizar. Ahora las consumen también el validador de
   fórmulas del Lab y el asistente, para que ninguna fórmula se salga de los
   rangos documentados.

   Los rangos son los mismos textos que se muestran en la web ("55–72%",
   "0.3–0.5%", "~72%", "c.s."); lib/validar-formula.ts los interpreta.
*/
...
export const basesCosmetica: Formula[] = [
  {
