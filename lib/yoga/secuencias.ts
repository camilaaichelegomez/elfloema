...
export const SECUENCIAS: Secuencia[] = [
  // ══ Saludos al sol ═════════════════════════════════════════
  {
    ...
    fase: "saludos",
    /* El saludo al sol clásico completo, tal como se enseña en hatha: diez
       posturas que bajan al suelo por la plancha y el saludo de ocho puntos,
       y vuelven por la cobra y el perro. La versión corta que había antes se
       saltaba justo la parte del suelo. */
    pasos: [
      "sal-manos-pecho",
      "sal-brazos-arriba",
      "pie-pinza",
    ...
    guion: [
      ...
      "Exhala: junta los pies y suelta el tronco sobre las piernas.",
    ...
    carga: 2,
    porque:
      "Es la secuencia que calienta el cuerpo entero, de pie al suelo y de vuelta: sube los brazos, baja a los pies, una pierna atrás, plancha, el saludo de ocho puntos, cobra, perro, y vuelve. Cada vuelta cambia la pierna que va atrás, así los dos lados quedan parejos. Tres vueltas es la pauta clásica; con dos ya sirve.",
  ...
  },
  {
    ...
    fase: "saludos",
    /* La versión de ashtanga y vinyasa: la misma forma del clásico, pero
       bajando por chaturanga. Se empieza y se termina de pie, quieta. */
    pasos: [
      "sal-manos-pecho",
      "sal-brazos-arriba",
      "pie-pinza",
    ...
    guion: [
      ...
      "Exhala: lleva las manos a los pies.",
      "Inhala: estira la espalda, mirada adelante, manos en las espinillas.",
      "Exhala: pierna {pierna} atrás y, en la misma respiración, la {otra}. Plancha.",
